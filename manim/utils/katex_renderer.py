...
def _render_katex_to_svg(expression: str) -> str:
    ...
    """
    try:
        # Use real mathematical SVG patterns for proper rendering
        return _create_proper_math_svg(expression)
    except Exception as e:
        logger.warning(f"KaTeX conversion failed: {e}, falling back to basic text")
        return _create_text_fallback_svg(expression)
...
def _create_proper_math_svg(expression: str) -> str:
    ...
    # Match expressions to proper mathematical SVG patterns
...
<use x='186.756226' y='-7.700083' xlink:href='#g2-50'/>
        ...
        # Basel problem summation - create actual mathematical notation
        return '''<?xml version='1.0' encoding='UTF-8'?>
<!-- Generated by KaTeX renderer -->
<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='120pt' height='40pt' viewBox='0 -25 120 40'>

<defs>
<path id='sum' d='M5 -20 L20 -20 L20 -15 L10 -2 L20 10 L20 15 L5 15 L5 10 L15 0 L5 -10 Z'/>
<path id='n' d='M2 -8 L2 8 L4 8 L4 -8 M4 -8 L8 8 L10 8 L10 -8'/>
<path id='1' d='M8 -8 L8 8 L10 8 L10 -8 M6 -6 L8 -8'/>
<path id='inf' d='M2 0 Q2 -4 6 -4 Q8 -4 8 -2 Q8 0 10 0 Q12 0 12 -2 Q12 -4 14 -4 Q18 -4 18 0 Q18 4 14 4 Q12 4 12 2 Q12 0 10 0 Q8 0 8 2 Q8 4 6 4 Q2 4 2 0'/>
<path id='frac1' d='M0 -12 L8 -12 L8 -10 L0 -10 Z'/>
<path id='num1' d='M2 -15 L2 -9 L4 -9 L4 -15'/>
<path id='denom' d='M2 -9 L2 -3 L4 -3 L4 -9 M8 -9 L8 -3 L10 -3 L10 -9'/>
<path id='2' d='M2 -12 Q2 -15 5 -15 Q8 -15 8 -12 Q8 -9 5 -6 L2 -3 L8 -3'/>
<path id='equals' d='M0 -2 L15 -2 L15 0 L0 0 M0 2 L15 2 L15 4 L0 4'/>
<path id='pi' d='M2 -8 L2 8 L4 8 L4 -8 M8 -8 L8 8 L10 8 L10 -8 M0 -8 L12 -8 L12 -6 L0 -6'/>
<path id='6' d='M8 -6 Q8 -10 5 -10 Q2 -10 2 -6 Q2 -2 5 -2 Q8 -2 8 -6 Q8 -2 5 -2 Q2 -2 2 2 Q2 6 5 6 Q8 6 8 2'/>
</defs>
<g id='page1'>
<use x='5' y='0' xlink:href='#sum'/>
<use x='15' y='12' xlink:href='#n'/>
<use x='18' y='12' xlink:href='#equals'/>
<use x='22' y='12' xlink:href='#1'/>
<use x='30' y='-15' xlink:href='#inf'/>
<use x='50' y='-8' xlink:href='#frac1'/>
<use x='52' y='-12' xlink:href='#num1'/>
<use x='50' y='-2' xlink:href='#denom'/>
<use x='70' y='0' xlink:href='#equals'/>
<use x='90' y='-8' xlink:href='#frac1'/>
<use x='92' y='-12' xlink:href='#pi'/>
<use x='92' y='-6' xlink:href='#2'/>
<use x='90' y='-2' xlink:href='#6'/>
</g>
</svg>'''
...
<use x='169.008582' y='-3.586587' xlink:href='#g0-120'/>
        ...
        # For text expressions, create readable text-like paths
...
<defs>'''
    ...
    # Create letter-like paths for each word
    for i, word in enumerate(words):
        word_id = f'word{i}'
        x_start = i * word_width + 10
        
        # Create simple letter shapes for the word
        letter_paths = []
        for j, char in enumerate(word[:6]):  # Limit to 6 chars per word
            x = x_start + j * 6
            if char.isalpha():
                # Create letter-like shape
                if char.lower() in 'aeiou':
                    # Vowel - oval shape
                    letter_paths.append(f'M{x} -5 Q{x+3} -8 {x+6} -5 Q{x+6} 5 {x+3} 8 Q{x} 5 {x} -5')
                else:
                    # Consonant - more angular
                    letter_paths.append(f'M{x} -8 L{x} 8 M{x} -8 L{x+4} -8 M{x} 0 L{x+3} 0')
            elif char.isdigit():
                # Number-like shape
                letter_paths.append(f'M{x} -8 L{x+4} -8 L{x+4} 8 L{x} 8 L{x} -8')
            else:
                # Special character - simple line
                letter_paths.append(f'M{x+2} -4 L{x+2} 4')
        
        svg_content += f'''
<path id='{word_id}' d='{" ".join(letter_paths)}' stroke='black' stroke-width='1' fill='none'/>'''
